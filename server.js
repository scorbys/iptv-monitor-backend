...
const FAQ_DATA = [
  ...
  },
  {
    ...
    solutions: [
      "Reset network configuration on Chromecast",
      "Verify WiFi router is functioning properly",
      "Check for network interference or weak signal",
      "Reconnect to WiFi network",
    ],
    detailedSteps: [
      "Buka aplikasi Google Home di smartphone",
      "Pilih perangkat Chromecast yang bermasalah",
      "Tap icon Settings (gear) di pojok kanan atas",
      "Pilih 'WiFi' atau 'Network Settings'",
      "Tap 'Forget Network' untuk hapus koneksi WiFi saat ini",
      "Scan ulang jaringan WiFi yang tersedia",
      "Pilih jaringan WiFi yang benar dan masukkan password",
      "Tunggu hingga Chromecast tersambung kembali",
      "Test koneksi dengan streaming content",
    ],
    troubleshooting: [
      "Jika WiFi tidak terdeteksi, restart router WiFi",
      "Pastikan Chromecast berada dalam jangkauan WiFi router",
      "Periksa apakah device lain dapat connect ke WiFi",
      "Coba gunakan WiFi 2.4GHz jika 5GHz bermasalah",
    ],
    actionType: "System",
    priority: "High",
  ...
  },
  {
    ...
    solutions: [
      "Restart system initialization process",
      "Check firmware version and update if needed",
      "Perform factory reset if persistent",
      "Verify boot sequence is completing properly",
    ],
    detailedSteps: [
      "Matikan IPTV set-top box sepenuhnya",
      "Cabut kabel power dari stop kontak",
      "Tunggu minimal 30 detik",
      "Colokkan kembali kabel power",
      "Nyalakan set-top box dan tunggu proses boot",
      "Perhatikan LED indicator selama boot process",
      "Jika stuck di logo atau loading screen, coba lagi",
      "Jika masih error, akses recovery mode (tekan tombol reset)",
      "Pilih 'Restart System' atau 'Clear Cache'",
    ],
    troubleshooting: [
      "Jika error persisten, cek versi firmware di Settings",
      "Update firmware jika versi lama terdeteksi",
      "Backup data penting sebelum factory reset",
      "Hubungi support jika firmware update gagal",
    ],
    actionType: "System",
    priority: "High",
  ...
  },
  {
    ...
    device: "Chromecast",
    issue: "No Device Found: Logined",
    solutions: [
      "Verify device registration status in account",
      "Re-authenticate device credentials",
      "Remove and re-add device to Google Home",
      "Check if device is linked to correct Google account",
    ],
    detailedSteps: [
      "Buka aplikasi Google Home",
      "Tap icon profile di pojok kanan atas",
      "Pilih 'Google Account' dan login jika diminta",
      "Kembali ke Home, tap '+' untuk tambah device",
      "Pilih 'Set up device' → 'New devices'",
      "Pilih Home tempat device akan ditambahkan",
      "Tunggu scan otomatis untuk deteksi Chromecast",
      "Jika terdeteksi, ikuti on-screen instructions",
      "Verifikasi kode yang muncul di TV matches dengan app",
      "Complete setup dan test device",
    ],
    troubleshooting: [
      "Jika device tidak terdeteksi, pastikan sudah di-reset",
      "Check apakah Chromecast terhubung ke WiFi yang sama",
      "Pastikan Google account yang login adalah pemilik device",
      "Hapus device dari account lama jika pindah ownership",
    ],
    actionType: "On Site",
    priority: "Medium",
